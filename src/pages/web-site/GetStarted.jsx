...
const GetStarted = () => {
  ...
  const handleProceedClick = () => {
    switch (activeButton) {
      case "applicant":
        window.location.href = "/get-started/applicantregistration";
        break;
      case "student":
        window.location.href = "/student/dashboard";
        break;
      case "teacher":
        window.location.href = "/get-started/teacher/signup";
        break;
      default:
        break;
    }
  ...
  return (
    <div className="bg-blueBg h-[100vh] flex flex-col ">
      ...
      <div className="flex w-full h-full justify-center items-center gap-10">
        <div className="bg-white w-[40%] h-[60vh] shadow-lg shadow-black/40 rounded-[16px] flex flex-col pt-8">
          <form
            onSubmit={(e) => e.preventDefault()}
            className="w-full h-full px-4 flex flex-col gap-4 items-center"
          >
            <div className="bg-transparent border-[1px] border-secondary border-opacity-30 rounded-[8px] flex flex-col justify-center gap-4 px-4 h-3/5 w-[90%]">
            ...
            <div className="h-1/5 w-[90%]">
              <button
                ...
                className="bg-primary w-full rounded-[8px] h-full text-white font-semibold"
